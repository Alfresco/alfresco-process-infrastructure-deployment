...
![Version: 7.15.5-SNAPSHOT](https://img.shields.io/badge/Version-7.15.5--SNAPSHOT-informational?style=flat-square) ![AppVersion: 7.15.0](https://img.shields.io/badge/AppVersion-7.15.0-informational?style=flat-square)
...
| alfresco-deployment-service.applications.image.tag | string | `"7.15.0"` | default tag for all application images |
...
| alfresco-deployment-service.image.tag | string | `"7.15.2-alpha.2"` |  |
...
| alfresco-identity-adapter-service.image.tag | string | `"7.15.2-alpha.1"` |  |
...
| alfresco-modeling-app.image.tag | string | `"7.15.1"` |  |
...
| alfresco-modeling-service.image.tag | string | `"7.15.2-alpha.3"` |  |
...
| alfresco-process-analytics-playground.image.tag | string | `"7.15.2-alpha.2"` |  |
...
| alfresco-process-analytics-service.image.tag | string | `"7.15.2-alpha.2"` |  |
...
| alfresco-static-resources.image.tag | string | `"7.15.0"` |  |
...
| alfresco-tika-service.image.tag | string | `"7.15.2-alpha.2"` |  |
