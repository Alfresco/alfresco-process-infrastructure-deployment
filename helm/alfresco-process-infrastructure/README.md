...
![Version: 7.10.0-rc.30](https://img.shields.io/badge/Version-7.10.0--rc.30-informational?style=flat-square) ![AppVersion: 7.10.0-rc.30](https://img.shields.io/badge/AppVersion-7.10.0--rc.30-informational?style=flat-square)
...
|------------|------|---------|
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-admin-app(common) | 7.10.0-alpha.3 |
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-process-analytics-playground(common) | 7.10.0-alpha.3 |
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-modeling-service(common) | 7.10.0-alpha.3 |
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-process-analytics-service(common) | 7.10.0-alpha.3 |
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-tika-service(common) | 7.10.0-alpha.3 |
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-modeling-app(common) | 7.10.0-alpha.3 |
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-deployment-service(common) | 7.10.0-alpha.3 |
| https://activiti.github.io/activiti-cloud-helm-charts | common | 7.10.0-alpha.3 |
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-identity-adapter-service(common) | 7.10.0-alpha.3 |
...
| alfresco-admin-app.image.tag | string | `"7.10.0-rc.30"` |  |
...
| alfresco-deployment-service.applications.image.tag | string | `"7.10.0-rc.30"` | default tag for all application images |
...
| alfresco-deployment-service.image.tag | string | `"7.10.0-rc.30"` |  |
...
| alfresco-identity-adapter-service.image.tag | string | `"7.10.0-rc.30"` |  |
...
| alfresco-modeling-app.image.tag | string | `"7.10.0-rc.30"` |  |
...
| alfresco-modeling-service.image.tag | string | `"7.10.0-rc.30"` |  |
...
| alfresco-process-analytics-playground.image.tag | string | `"7.10.0-rc.30"` |  |
...
| alfresco-process-analytics-service.image.tag | string | `"7.10.0-rc.30"` |  |
...
| global | object | `{"acs":{"activemq":{"password":"","url":"","username":""},"admin":{"password":"","username":""},"enabled":false,"host":"{{ template \"common.gateway-host\" . }}","url":""},"gateway":{"annotations":{},"domain":"","host":"{{ template \"common.gateway-domain\" . }}","http":"false","tlsacme":"false"},"hxp":{"accountId":"","context":{"environment":""}},"hxpr":{"admin":{"clientId":"","clientSecret":""},"enabled":false},"keycloak":{"clientId":"activiti-keycloak","clientSecret":"d2b835b5-efdf-4448-8d55-89eaaca9fc96","host":"{{ template \"common.gateway-host\" . }}","realm":"alfresco","resource":"alfresco","url":""},"registryPullSecrets":["quay-registry-secret"]}` | for common values see https://github.com/Activiti/activiti-cloud-common-chart/blob/master/charts/common/README.md |
...
| global.hxp.context.environment | string | `""` | the HxP environment to be used by default by the identity adapter |
