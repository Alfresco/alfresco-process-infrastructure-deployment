...
| alfresco-deployment-service.applications.image.tag | string | `"7.19.3"` | default tag for all application images |
...
| alfresco-deployment-service.image.tag | string | `"7.19.3"` |  |
...
| alfresco-identity-adapter-service.image.tag | string | `"7.19.3"` |  |
...
| alfresco-modeling-service.image.tag | string | `"7.19.3"` |  |
...
| alfresco-process-analytics-playground.image.tag | string | `"7.19.3"` |  |
...
| alfresco-process-analytics-service.image.tag | string | `"7.19.3"` |  |
...
| alfresco-tika-service.image.tag | string | `"7.19.3"` |  |
