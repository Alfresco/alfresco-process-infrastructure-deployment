...
![Version: 7.14.0-mock](https://img.shields.io/badge/Version-7.14.0--mock-informational?style=flat-square) ![AppVersion: 7.14.0-mock](https://img.shields.io/badge/AppVersion-7.14.0--mock-informational?style=flat-square)
...
|------------|------|---------|
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-tika-service(common) | 7.14.0-rc.21 |
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-identity-adapter-service(common) | 7.14.0-rc.21 |
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-modeling-service(common) | 7.14.0-rc.21 |
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-process-analytics-playground(common) | 7.14.0-rc.21 |
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-process-analytics-service(common) | 7.14.0-rc.21 |
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-modeling-app(common) | 7.14.0-rc.21 |
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-deployment-service(common) | 7.14.0-rc.21 |
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-admin-app(common) | 7.14.0-rc.21 |
| https://activiti.github.io/activiti-cloud-helm-charts | common | 7.14.0-rc.21 |
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-static-resources(common) | 7.14.0-rc.21 |
...
| alfresco-admin-app.image.tag | string | `"7.14.0-mock"` |  |
...
| alfresco-deployment-service.applications.image.tag | string | `"7.14.0-mock"` | default tag for all application images |
...
| alfresco-deployment-service.image.tag | string | `"7.14.0-mock"` |  |
...
| alfresco-identity-adapter-service.image.tag | string | `"7.14.0-mock"` |  |
...
| alfresco-modeling-app.image.tag | string | `"7.14.0-mock"` |  |
...
| alfresco-modeling-service.image.tag | string | `"7.14.0-mock"` |  |
...
| alfresco-process-analytics-playground.image.tag | string | `"7.14.0-mock"` |  |
...
| alfresco-process-analytics-service.image.tag | string | `"7.14.0-mock"` |  |
...
| alfresco-static-resources.image.tag | string | `"7.14.0-mock"` |  |
...
| alfresco-tika-service.image.tag | string | `"7.14.0-mock"` |  |
