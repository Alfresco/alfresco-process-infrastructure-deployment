...
| alfresco-process-analytics-service.opensearch.password | string | `"{{ tpl .Values.global.opensearch.password $ }}"` |  |
| alfresco-process-analytics-service.opensearch.username | string | `"{{ tpl .Values.global.opensearch.username $ }}"` |  |
