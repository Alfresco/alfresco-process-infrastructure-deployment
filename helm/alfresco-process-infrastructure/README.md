...
| alfresco-deployment-service.image.tag | string | `"7.9.0-alpha.56"` |  |
...
| alfresco-identity-adapter-service.image.tag | string | `"7.9.0-alpha.28"` |  |
...
| alfresco-modeling-service.image.tag | string | `"7.9.0-alpha.48"` |  |
