...
![Version: 7.19.2-mock](https://img.shields.io/badge/Version-7.19.2--mock-informational?style=flat-square) ![AppVersion: 7.19.2-mock](https://img.shields.io/badge/AppVersion-7.19.2--mock-informational?style=flat-square)
...
| alfresco-admin-app.image.tag | string | `"7.19.2-test1"` |  |
...
| alfresco-deployment-service.applications.image.tag | string | `"7.19.2-mock"` | default tag for all application images |
...
| alfresco-deployment-service.image.tag | string | `"7.19.2-mock"` |  |
...
| alfresco-identity-adapter-service.image.tag | string | `"7.19.2-mock"` |  |
...
| alfresco-modeling-app.image.tag | string | `"7.19.2-test1"` |  |
...
| alfresco-modeling-service.image.tag | string | `"7.19.2-mock"` |  |
...
| alfresco-process-analytics-playground.image.tag | string | `"7.19.2-mock"` |  |
...
| alfresco-process-analytics-service.image.tag | string | `"7.19.2-mock"` |  |
...
| alfresco-static-resources.image.tag | string | `"7.19.1"` |  |
...
| alfresco-tika-service.image.tag | string | `"7.19.2-mock"` |  |
