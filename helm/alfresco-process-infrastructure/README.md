...
| alfresco-admin-app.image.tag | string | `"7.1.0-M15"` |  |
...
| alfresco-deployment-service.applications.image.tag | string | `"7.1.0-M15"` | default tag for all images used in application |
...
| alfresco-deployment-service.image.tag | string | `"7.1.0-M15"` |  |
...
| alfresco-modeling-app.image.tag | string | `"7.1.0-M15"` |  |
...
| alfresco-modeling-service.image.tag | string | `"7.1.0-M15"` |  |
