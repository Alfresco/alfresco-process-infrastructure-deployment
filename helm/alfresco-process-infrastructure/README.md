...
| alfresco-deployment-service.image.tag | string | `"7.9.0-alpha.24"` |  |
...
| alfresco-modeling-service.image.tag | string | `"7.9.0-alpha.22"` |  |
...
| alfresco-process-analytics-playground.image.tag | string | `"7.9.0-alpha.17"` |  |
...
| alfresco-process-analytics-service.image.tag | string | `"7.9.0-alpha.17"` |  |
