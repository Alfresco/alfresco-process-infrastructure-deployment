...
| alfresco-deployment-service.image.tag | string | `"7.17.0-alpha.8"` |  |
...
| alfresco-identity-adapter-service.image.tag | string | `"7.17.0-alpha.1"` |  |
...
| alfresco-modeling-service.image.tag | string | `"7.17.0-alpha.8"` |  |
