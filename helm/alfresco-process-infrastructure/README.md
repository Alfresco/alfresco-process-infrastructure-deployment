...
| alfresco-modeling-service.image.tag | string | `"7.10.0-alpha.34"` |  |
...
| alfresco-process-analytics-playground.image.tag | string | `"7.10.0-alpha.27"` |  |
...
| alfresco-process-analytics-service.image.tag | string | `"7.10.0-alpha.27"` |  |
