...
| alfresco-deployment-service.image.tag | string | `"7.6.0-alpha.47"` |  |
...
| alfresco-identity-adapter-service.image.tag | string | `"7.6.0-alpha.11"` |  |
...
| alfresco-modeling-service.image.tag | string | `"7.6.0-alpha.17"` |  |
...
| alfresco-process-analytics-playground.image.tag | string | `"7.6.0-alpha.11"` |  |
...
| alfresco-process-analytics-service.image.tag | string | `"7.6.0-alpha.11"` |  |
