...
|------------|------|---------|
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-process-analytics-service(common) | 8.8.0-alpha.10 |
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-tika-service(common) | 8.8.0-alpha.10 |
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-modeling-service(common) | 8.8.0-alpha.10 |
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-static-resources(common) | 8.8.0-alpha.10 |
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-identity-adapter-service(common) | 8.8.0-alpha.10 |
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-modeling-app(common) | 8.8.0-alpha.10 |
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-admin-app(common) | 8.8.0-alpha.10 |
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-deployment-service(common) | 8.8.0-alpha.10 |
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-process-analytics-playground(common) | 8.8.0-alpha.10 |
| https://activiti.github.io/activiti-cloud-helm-charts | common | 8.8.0-alpha.10 |
...
| alfresco-deployment-service.image.tag | string | `"7.20.0-alpha.474"` |  |
...
| alfresco-identity-adapter-service.image.tag | string | `"7.20.0-alpha.205"` |  |
...
| alfresco-modeling-service.image.tag | string | `"7.20.0-alpha.474"` |  |
...
| alfresco-process-analytics-playground.image.tag | string | `"7.20.0-alpha.263"` |  |
...
| alfresco-process-analytics-service.image.tag | string | `"7.20.0-alpha.263"` |  |
...
| alfresco-tika-service.image.tag | string | `"7.20.0-alpha.263"` |  |
