...
| alfresco-deployment-service.image.tag | string | `"7.1.0-M9"` |  |
...
| alfresco-modeling-app.image.tag | string | `"7.1.0-M9"` |  |
...
| alfresco-modeling-service.image.tag | string | `"7.1.0-M9"` |  |
