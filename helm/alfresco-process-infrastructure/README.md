...
![Version: 7.20.0-mock](https://img.shields.io/badge/Version-7.20.0--mock-informational?style=flat-square) ![AppVersion: 7.20.0-mock](https://img.shields.io/badge/AppVersion-7.20.0--mock-informational?style=flat-square)
...
|------------|------|---------|
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-process-analytics-service(common) | 9.0.0-mock |
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-tika-service(common) | 9.0.0-mock |
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-modeling-service(common) | 9.0.0-mock |
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-static-resources(common) | 9.0.0-mock |
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-identity-adapter-service(common) | 9.0.0-mock |
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-modeling-app(common) | 9.0.0-mock |
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-admin-app(common) | 9.0.0-mock |
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-deployment-service(common) | 9.0.0-mock |
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-process-analytics-playground(common) | 9.0.0-mock |
| https://activiti.github.io/activiti-cloud-helm-charts | common | 9.0.0-mock |
...
| alfresco-admin-app.image.tag | string | `"7.20.0-mock"` |  |
...
| alfresco-deployment-service.applications.aspose.license.password | string | `""` |  |
| alfresco-deployment-service.applications.aspose.license.salt | string | `""` |  |
...
| alfresco-deployment-service.applications.image.tag | string | `"7.20.0-mock"` | default tag for all application images |
...
| alfresco-deployment-service.image.tag | string | `"7.20.0-mock"` |  |
...
| alfresco-identity-adapter-service.image.tag | string | `"7.20.0-mock"` |  |
...
| alfresco-identity-adapter-service.livenessProbe.path | string | `"/actuator/health/liveness"` |  |
...
| alfresco-identity-adapter-service.readinessProbe.path | string | `"/actuator/health/readiness"` |  |
...
| alfresco-modeling-app.image.tag | string | `"7.20.0-mock"` |  |
...
| alfresco-modeling-service.image.tag | string | `"7.20.0-mock"` |  |
...
| alfresco-process-analytics-playground.image.tag | string | `"7.20.0-mock"` |  |
...
| alfresco-process-analytics-service.image.tag | string | `"7.20.0-mock"` |  |
...
| alfresco-process-analytics-service.livenessProbe.path | string | `"{{ tpl .Values.ingress.path $ | trimSuffix \"/\" }}/actuator/health/liveness"` |  |
...
| alfresco-process-analytics-service.readinessProbe.path | string | `"{{ tpl .Values.ingress.path $ | trimSuffix \"/\" }}/actuator/health/readiness"` |  |
...
| alfresco-static-resources.image.pullPolicy | string | `"IfNotPresent"` |  |
| alfresco-static-resources.image.repository | string | `"quay.io/alfresco/apa-static-resources"` |  |
| alfresco-static-resources.image.tag | string | `"7.20.0-mock"` |  |
...
| alfresco-tika-service.image.pullPolicy | string | `"IfNotPresent"` |  |
| alfresco-tika-service.image.repository | string | `"quay.io/alfresco/alfresco-process-tika"` |  |
| alfresco-tika-service.image.tag | string | `"7.20.0-mock"` |  |
