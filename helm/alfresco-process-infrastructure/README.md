...
| alfresco-deployment-service.image.tag | string | `"7.17.0-alpha.46"` |  |
...
| alfresco-identity-adapter-service.image.tag | string | `"7.17.0-alpha.16"` |  |
...
| alfresco-modeling-service.image.tag | string | `"7.17.0-alpha.46"` |  |
