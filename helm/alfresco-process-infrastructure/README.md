...
| alfresco-deployment-service.image.tag | string | `"7.9.0-alpha.13"` |  |
...
| alfresco-modeling-service.image.tag | string | `"7.9.0-alpha.14"` |  |
...
| alfresco-process-analytics-playground.image.tag | string | `"7.9.0-alpha.11"` |  |
...
| alfresco-process-analytics-service.image.tag | string | `"7.9.0-alpha.11"` |  |
