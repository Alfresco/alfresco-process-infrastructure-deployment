...
![Version: 7.9.0-alpha.51](https://img.shields.io/badge/Version-7.9.0--alpha.51-informational?style=flat-square) ![AppVersion: 7.9.0-SNAPSHOT](https://img.shields.io/badge/AppVersion-7.9.0--SNAPSHOT-informational?style=flat-square)
...
| alfresco-deployment-service.image.tag | string | `"7.9.0-alpha.65"` |  |
...
| alfresco-identity-adapter-service.image.tag | string | `"7.9.0-alpha.33"` |  |
...
| alfresco-modeling-service.image.tag | string | `"7.9.0-alpha.54"` |  |
...
| alfresco-process-analytics-playground.image.tag | string | `"7.9.0-alpha.39"` |  |
...
| alfresco-process-analytics-service.image.tag | string | `"7.9.0-alpha.39"` |  |
