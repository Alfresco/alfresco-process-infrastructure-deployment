...
![Version: 7.12.0-rc.81](https://img.shields.io/badge/Version-7.12.0--rc.81-informational?style=flat-square) ![AppVersion: 7.12.0-rc.81](https://img.shields.io/badge/AppVersion-7.12.0--rc.81-informational?style=flat-square)
...
| alfresco-admin-app.image.tag | string | `"7.12.0-rc.81"` |  |
...
| alfresco-deployment-service.applications.image.tag | string | `"7.12.0-rc.81"` | default tag for all application images |
...
| alfresco-deployment-service.image.tag | string | `"7.12.0-rc.81"` |  |
...
| alfresco-identity-adapter-service.image.tag | string | `"7.12.0-rc.81"` |  |
...
| alfresco-modeling-app.image.tag | string | `"7.12.0-rc.81"` |  |
...
| alfresco-modeling-service.image.tag | string | `"7.12.0-rc.81"` |  |
...
| alfresco-process-analytics-playground.image.tag | string | `"7.12.0-rc.81"` |  |
...
| alfresco-process-analytics-service.image.tag | string | `"7.12.0-rc.81"` |  |
