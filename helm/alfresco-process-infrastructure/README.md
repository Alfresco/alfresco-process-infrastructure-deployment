...
| alfresco-deployment-service.image.tag | string | `"7.17.0-alpha.73"` |  |
...
| alfresco-modeling-service.image.tag | string | `"7.17.0-alpha.73"` |  |
...
| alfresco-process-analytics-playground.image.tag | string | `"7.17.0-alpha.30"` |  |
...
| alfresco-process-analytics-service.image.tag | string | `"7.17.0-alpha.30"` |  |
...
| alfresco-tika-service.image.tag | string | `"7.17.0-alpha.30"` |  |
