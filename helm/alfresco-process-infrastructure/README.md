...
![Version: 7.19.2-alpha.2](https://img.shields.io/badge/Version-7.19.2--alpha.2-informational?style=flat-square) ![AppVersion: 7.19.2-SNAPSHOT](https://img.shields.io/badge/AppVersion-7.19.2--SNAPSHOT-informational?style=flat-square)
...
| alfresco-deployment-service.image.tag | string | `"7.19.2-alpha.2"` |  |
...
| alfresco-modeling-service.image.tag | string | `"7.19.2-alpha.2"` |  |
