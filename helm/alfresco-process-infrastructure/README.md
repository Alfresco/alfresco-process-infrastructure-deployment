...
| alfresco-process-analytics-playground.image.tag | string | `"7.19.4-alpha.2"` |  |
...
| alfresco-process-analytics-service.image.tag | string | `"7.19.4-alpha.2"` |  |
...
| alfresco-tika-service.image.tag | string | `"7.19.4-alpha.2"` |  |
