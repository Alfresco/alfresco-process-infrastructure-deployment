...
| alfresco-deployment-service.image.tag | string | `"7.9.0-alpha.27"` |  |
...
| alfresco-modeling-service.image.tag | string | `"7.9.0-alpha.25"` |  |
...
| alfresco-process-analytics-playground.image.tag | string | `"7.9.0-alpha.19"` |  |
...
| alfresco-process-analytics-service.image.tag | string | `"7.9.0-alpha.19"` |  |
