...
| alfresco-deployment-service.applications.image.tag | string | `"7.9.2-mock"` | default tag for all application images |
...
| alfresco-deployment-service.image.tag | string | `"7.9.2-mock"` |  |
...
| alfresco-identity-adapter-service.image.tag | string | `"7.9.2-mock"` |  |
...
| alfresco-modeling-service.image.tag | string | `"7.9.2-mock"` |  |
...
| alfresco-process-analytics-playground.image.tag | string | `"7.9.2-mock"` |  |
...
| alfresco-process-analytics-service.image.tag | string | `"7.9.2-mock"` |  |
