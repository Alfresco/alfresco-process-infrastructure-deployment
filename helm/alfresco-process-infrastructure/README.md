...
|------------|------|---------|
| https://activiti.github.io/activiti-cloud-helm-charts | common | 7.1.0-M16 |
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-admin-app(common) | 7.1.0-M16 |
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-modeling-service(common) | 7.1.0-M16 |
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-modeling-app(common) | 7.1.0-M16 |
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-deployment-service(common) | 7.1.0-M16 |
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-tika-service(common) | 7.1.0-M16 |
...
| alfresco-admin-app.image.tag | string | `"7.1.0-M16"` |  |
...
| alfresco-deployment-service.applications.image.tag | string | `"7.1.0-M16"` | default tag for all images used in application |
...
| alfresco-deployment-service.image.tag | string | `"7.1.0-M16"` |  |
...
| alfresco-modeling-app.image.tag | string | `"7.1.0-M16"` |  |
...
| alfresco-modeling-service.image.tag | string | `"7.1.0-M16"` |  |
