...
![Version: 7.12.0-alpha.204](https://img.shields.io/badge/Version-7.12.0--alpha.204-informational?style=flat-square) ![AppVersion: 7.12.0-SNAPSHOT](https://img.shields.io/badge/AppVersion-7.12.0--SNAPSHOT-informational?style=flat-square)
...
| alfresco-deployment-service.image.tag | string | `"7.12.0-alpha.225"` |  |
...
| alfresco-modeling-service.image.tag | string | `"7.12.0-alpha.160"` |  |
