...
| alfresco-deployment-service.image.tag | string | `"7.8.0-rc.3"` |  |
...
| alfresco-identity-adapter-service.image.tag | string | `"7.8.0-rc.3"` |  |
...
| alfresco-modeling-app.image.tag | string | `"7.8.0-rc.3"` |  |
...
| alfresco-modeling-service.image.tag | string | `"7.8.0-rc.3"` |  |
...
| alfresco-process-analytics-playground.image.tag | string | `"7.8.0-rc.3"` |  |
...
| alfresco-process-analytics-service.image.tag | string | `"7.8.0-rc.3"` |  |
