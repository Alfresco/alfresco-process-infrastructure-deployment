...
| alfresco-deployment-service.image.tag | string | `"7.8.0-alpha.9"` |  |
...
| alfresco-process-analytics-playground.image.tag | string | `"7.8.0-alpha.3"` |  |
...
| alfresco-process-analytics-service.image.tag | string | `"7.8.0-alpha.3"` |  |
