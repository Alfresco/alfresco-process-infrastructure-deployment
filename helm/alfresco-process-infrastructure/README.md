...
| alfresco-deployment-service.applications.analytics.metrics.export.host | string | `"{{ tpl .Values.global.opensearch.host $ }}"` |  |
| alfresco-deployment-service.applications.analytics.metrics.export.password | string | `"{{ .Values.global.opensearch.password }}"` |  |
| alfresco-deployment-service.applications.analytics.metrics.export.username | string | `"{{ .Values.global.opensearch.username }}"` |  |
...
| alfresco-process-analytics-playground.env.ALFRESCO_PROCESS_ANALYTICS_GRAPHQL_CLIENT_URL | string | `"{{ tpl .Values.graphqlClientUrl $ }}"` |  |
...
| alfresco-process-analytics-service.metrics.client.host | string | `"{{ tpl .Values.global.opensearch.host $ }}"` |  |
| alfresco-process-analytics-service.metrics.client.password | string | `"{{ .Values.global.opensearch.password }}"` |  |
| alfresco-process-analytics-service.metrics.client.username | string | `"{{ .Values.global.opensearch.username }}"` |  |
