...
![Version: 7.3.0](https://img.shields.io/badge/Version-7.3.0-informational?style=flat-square) ![AppVersion: 7.3.0](https://img.shields.io/badge/AppVersion-7.3.0-informational?style=flat-square)
...
| alfresco-admin-app.image.tag | string | `"7.3.0"` |  |
...
| alfresco-deployment-service.applications.image.tag | string | `"7.3.0"` | default tag for all application images |
...
| alfresco-deployment-service.image.tag | string | `"7.3.0"` |  |
...
| alfresco-modeling-app.exampleProjects.resource | string | `"index_7.3.0.json"` |  |
...
| alfresco-modeling-app.image.tag | string | `"7.3.0"` |  |
...
| alfresco-modeling-service.exampleProjects.resource | string | `"index_7.3.0.json"` |  |
...
| alfresco-modeling-service.image.tag | string | `"7.3.0"` |  |
