...
| alfresco-deployment-service.applications.analytics.metrics.enabled | bool | `true` |  |
| alfresco-deployment-service.applications.analytics.opensearch.host | string | `"{{ tpl .Values.global.opensearch.host $ }}"` |  |
| alfresco-deployment-service.applications.analytics.opensearch.password | string | `"{{ .Values.global.opensearch.password }}"` |  |
| alfresco-deployment-service.applications.analytics.opensearch.username | string | `"{{ .Values.global.opensearch.username }}"` |  |
