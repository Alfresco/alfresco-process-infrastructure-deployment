...
![Version: 7.18.0-alpha.15](https://img.shields.io/badge/Version-7.18.0--alpha.15-informational?style=flat-square) ![AppVersion: 7.18.0-SNAPSHOT](https://img.shields.io/badge/AppVersion-7.18.0--SNAPSHOT-informational?style=flat-square)
...
| alfresco-deployment-service.image.tag | string | `"7.18.0-alpha.16"` |  |
...
| alfresco-identity-adapter-service.image.tag | string | `"7.18.0-alpha.8"` |  |
...
| alfresco-modeling-service.image.tag | string | `"7.18.0-alpha.16"` |  |
...
| alfresco-process-analytics-playground.image.tag | string | `"7.18.0-alpha.10"` |  |
...
| alfresco-process-analytics-service.image.tag | string | `"7.18.0-alpha.10"` |  |
...
| alfresco-tika-service.image.tag | string | `"7.18.0-alpha.10"` |  |
