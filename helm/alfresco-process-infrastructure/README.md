...
| alfresco-deployment-service.applications.datadog.apiKey | string | `nil` | configures application Datadog metrics export api key. Required if metricsExportEnabled=true |
...
| alfresco-deployment-service.applications.datadog.metricsExportEnabled | bool | `false` |  |
...
| global.datadog.enabled | bool | `false` | enable support for Datadog tracing agent instrumentation for AEE infrastructure services |
| global.datadog.env | string | `nil` | configures Datadog trace agent environment tag. Required if enabled=true. |
...
| global.datadog.traceAgentUrl | string | `nil` | configures Datadog trace agent url for AEE infrastructure services |
