...
| alfresco-deployment-service.image.tag | string | `"7.7.0-rc.70"` |  |
...
| alfresco-identity-adapter-service.image.tag | string | `"7.7.0-rc.70"` |  |
...
| alfresco-modeling-service.image.tag | string | `"7.7.0-rc.70"` |  |
...
| alfresco-process-analytics-playground.image.tag | string | `"7.7.0-rc.70"` |  |
...
| alfresco-process-analytics-service.image.tag | string | `"7.7.0-rc.70"` |  |
