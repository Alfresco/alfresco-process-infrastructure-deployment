...
| alfresco-admin-app.image.tag | string | `"7.4.0"` |  |
...
| alfresco-deployment-service.image.tag | string | `"7.4.0"` |  |
...
| alfresco-modeling-app.image.tag | string | `"7.4.0"` |  |
...
| alfresco-modeling-service.image.tag | string | `"7.4.0"` |  |
...
| alfresco-process-analytics-playground.image.tag | string | `"7.4.0"` |  |
...
| alfresco-process-analytics-service.image.tag | string | `"7.4.0"` |  |
