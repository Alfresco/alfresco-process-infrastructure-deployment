...
![Version: 7.15.0-alpha.117](https://img.shields.io/badge/Version-7.15.0--alpha.117-informational?style=flat-square) ![AppVersion: 7.15.0-SNAPSHOT](https://img.shields.io/badge/AppVersion-7.15.0--SNAPSHOT-informational?style=flat-square)
...
| alfresco-deployment-service.image.tag | string | `"7.15.0-alpha.94"` |  |
...
| alfresco-identity-adapter-service.image.tag | string | `"7.15.0-alpha.40"` |  |
...
| alfresco-modeling-service.image.tag | string | `"7.15.0-alpha.70"` |  |
...
| alfresco-process-analytics-playground.image.tag | string | `"7.15.0-alpha.34"` |  |
...
| alfresco-process-analytics-service.image.tag | string | `"7.15.0-alpha.34"` |  |
...
| alfresco-tika-service.image.tag | string | `"7.15.0-alpha.34"` |  |
