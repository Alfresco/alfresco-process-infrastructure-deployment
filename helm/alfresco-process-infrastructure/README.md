...
| alfresco-deployment-service.image.tag | string | `"7.16.0-alpha.58"` |  |
...
| alfresco-identity-adapter-service.image.tag | string | `"7.16.0-alpha.30"` |  |
...
| alfresco-modeling-service.image.tag | string | `"7.16.0-alpha.57"` |  |
...
| alfresco-process-analytics-playground.image.tag | string | `"7.16.0-alpha.41"` |  |
...
| alfresco-process-analytics-service.image.tag | string | `"7.16.0-alpha.41"` |  |
...
| alfresco-tika-service.image.tag | string | `"7.16.0-alpha.41"` |  |
