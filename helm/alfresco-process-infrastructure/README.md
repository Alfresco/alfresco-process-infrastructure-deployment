...
| alfresco-identity-adapter-service.image.tag | string | `"7.18.0-alpha.43"` |  |
...
| alfresco-process-analytics-playground.image.tag | string | `"7.18.0-alpha.42"` |  |
...
| alfresco-process-analytics-service.image.tag | string | `"7.18.0-alpha.42"` |  |
...
| alfresco-tika-service.image.tag | string | `"7.18.0-alpha.42"` |  |
