...
![Version: 7.8.0-SNAPSHOT](https://img.shields.io/badge/Version-7.8.0--SNAPSHOT-informational?style=flat-square) ![AppVersion: 7.8.0-SNAPSHOT](https://img.shields.io/badge/AppVersion-7.8.0--SNAPSHOT-informational?style=flat-square)
...
|------------|------|---------|
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-admin-app(common) | 7.8.0-alpha.1 |
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-process-analytics-playground(common) | 7.8.0-alpha.1 |
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-modeling-service(common) | 7.8.0-alpha.1 |
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-process-analytics-service(common) | 7.8.0-alpha.1 |
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-tika-service(common) | 7.8.0-alpha.1 |
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-modeling-app(common) | 7.8.0-alpha.1 |
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-deployment-service(common) | 7.8.0-alpha.1 |
| https://activiti.github.io/activiti-cloud-helm-charts | common | 7.8.0-alpha.1 |
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-identity-adapter-service(common) | 7.8.0-alpha.1 |
...
| alfresco-deployment-service.image.tag | string | `"7.8.0-alpha.20"` |  |
...
| alfresco-modeling-service.image.tag | string | `"7.8.0-alpha.10"` |  |
...
| alfresco-process-analytics-playground.image.tag | string | `"7.8.0-alpha.8"` |  |
...
| alfresco-process-analytics-service.image.tag | string | `"7.8.0-alpha.8"` |  |
