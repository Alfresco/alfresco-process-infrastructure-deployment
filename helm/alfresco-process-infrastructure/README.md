...
![Version: 7.17.0-alpha.54](https://img.shields.io/badge/Version-7.17.0--alpha.54-informational?style=flat-square) ![AppVersion: 7.17.0-SNAPSHOT](https://img.shields.io/badge/AppVersion-7.17.0--SNAPSHOT-informational?style=flat-square)
...
| alfresco-deployment-service.image.tag | string | `"7.17.0-alpha.74"` |  |
...
| alfresco-modeling-service.image.tag | string | `"7.17.0-alpha.74"` |  |
