...
|------------|------|---------|
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-admin-app(common) | 7.11.0-alpha.1 |
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-process-analytics-playground(common) | 7.11.0-alpha.1 |
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-modeling-service(common) | 7.11.0-alpha.1 |
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-process-analytics-service(common) | 7.11.0-alpha.1 |
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-tika-service(common) | 7.11.0-alpha.1 |
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-modeling-app(common) | 7.11.0-alpha.1 |
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-deployment-service(common) | 7.11.0-alpha.1 |
| https://activiti.github.io/activiti-cloud-helm-charts | common | 7.11.0-alpha.1 |
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-identity-adapter-service(common) | 7.11.0-alpha.1 |
...
| alfresco-deployment-service.image.tag | string | `"7.12.0-alpha.27"` |  |
...
| alfresco-identity-adapter-service.image.tag | string | `"7.12.0-alpha.14"` |  |
...
| alfresco-modeling-service.image.tag | string | `"7.12.0-alpha.19"` |  |
...
| alfresco-process-analytics-playground.image.tag | string | `"7.12.0-alpha.13"` |  |
...
| alfresco-process-analytics-service.image.tag | string | `"7.12.0-alpha.13"` |  |
...
| global | object | `{"acs":{"activemq":{"password":"","url":"","username":""},"admin":{"password":"","username":""},"enabled":false,"host":"{{ template \"common.gateway-host\" . }}","url":""},"gateway":{"annotations":{},"domain":"","host":"{{ template \"common.gateway-domain\" . }}","http":"false","tlsacme":"false"},"hxp":{"accountId":"","nucleusSnsArn":""},"hxpr":{"admin":{"clientId":"","clientSecret":""},"enabled":false},"keycloak":{"clientId":"activiti-keycloak","clientSecret":"d2b835b5-efdf-4448-8d55-89eaaca9fc96","host":"{{ template \"common.gateway-host\" . }}","realm":"alfresco","resource":"alfresco","url":""},"registryPullSecrets":["quay-registry-secret"]}` | for common values see https://github.com/Activiti/activiti-cloud-common-chart/blob/master/charts/common/README.md |
