...
![Version: 7.20.0-rc.442](https://img.shields.io/badge/Version-7.20.0--rc.442-informational?style=flat-square) ![AppVersion: 7.20.0-rc.442](https://img.shields.io/badge/AppVersion-7.20.0--rc.442-informational?style=flat-square)
...
| alfresco-admin-app.image.tag | string | `"7.20.0-rc.442"` |  |
...
| alfresco-deployment-service.applications.image.tag | string | `"7.20.0-rc.442"` | default tag for all application images |
...
| alfresco-deployment-service.image.tag | string | `"7.20.0-rc.442"` |  |
...
| alfresco-identity-adapter-service.image.tag | string | `"7.20.0-rc.442"` |  |
...
| alfresco-modeling-app.image.tag | string | `"7.20.0-rc.442"` |  |
...
| alfresco-modeling-service.image.tag | string | `"7.20.0-rc.442"` |  |
...
| alfresco-process-analytics-playground.image.tag | string | `"7.20.0-rc.442"` |  |
...
| alfresco-process-analytics-service.image.tag | string | `"7.20.0-rc.442"` |  |
...
| alfresco-static-resources.image.tag | string | `"7.20.0-rc.442"` |  |
...
| alfresco-tika-service.image.tag | string | `"7.20.0-rc.442"` |  |
