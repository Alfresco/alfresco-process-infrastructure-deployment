...
| alfresco-deployment-service.image.tag | string | `"7.17.0-alpha.66"` |  |
...
| alfresco-identity-adapter-service.image.tag | string | `"7.17.0-alpha.23"` |  |
...
| alfresco-modeling-service.image.tag | string | `"7.17.0-alpha.66"` |  |
...
| alfresco-process-analytics-playground.image.tag | string | `"7.17.0-alpha.25"` |  |
...
| alfresco-process-analytics-service.image.tag | string | `"7.17.0-alpha.25"` |  |
...
| alfresco-tika-service.image.tag | string | `"7.17.0-alpha.25"` |  |
