...
![Version: 7.19.4-SNAPSHOT](https://img.shields.io/badge/Version-7.19.4--SNAPSHOT-informational?style=flat-square) ![AppVersion: 7.19.4-SNAPSHOT](https://img.shields.io/badge/AppVersion-7.19.4--SNAPSHOT-informational?style=flat-square)
...
| alfresco-deployment-service.image.tag | string | `"7.19.3-alpha.1"` |  |
...
| alfresco-identity-adapter-service.image.tag | string | `"7.19.4-alpha.1"` |  |
...
| alfresco-modeling-service.image.tag | string | `"7.19.3-alpha.1"` |  |
...
| alfresco-process-analytics-playground.image.tag | string | `"7.19.3-alpha.2"` |  |
...
| alfresco-process-analytics-service.image.tag | string | `"7.19.3-alpha.2"` |  |
...
| alfresco-tika-service.image.tag | string | `"7.19.3-alpha.2"` |  |
