...
![Version: 7.9.0](https://img.shields.io/badge/Version-7.9.0-informational?style=flat-square) ![AppVersion: 7.9.0](https://img.shields.io/badge/AppVersion-7.9.0-informational?style=flat-square)
...
| alfresco-process-analytics-playground.image.tag | string | `"7.9.0"` |  |
...
| alfresco-process-analytics-service.image.tag | string | `"7.9.0"` |  |
