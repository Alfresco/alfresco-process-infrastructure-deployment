...
| alfresco-deployment-service.image.tag | string | `"7.18.0-alpha.95"` |  |
...
| alfresco-identity-adapter-service.image.tag | string | `"7.18.0-alpha.44"` |  |
...
| alfresco-modeling-service.image.tag | string | `"7.18.0-alpha.95"` |  |
...
| alfresco-process-analytics-playground.image.tag | string | `"7.18.0-alpha.43"` |  |
...
| alfresco-process-analytics-service.image.tag | string | `"7.18.0-alpha.43"` |  |
...
| alfresco-tika-service.image.tag | string | `"7.18.0-alpha.43"` |  |
