...
![Version: 7.9.0-alpha.50](https://img.shields.io/badge/Version-7.9.0--alpha.50-informational?style=flat-square) ![AppVersion: 7.9.0-SNAPSHOT](https://img.shields.io/badge/AppVersion-7.9.0--SNAPSHOT-informational?style=flat-square)
...
| alfresco-deployment-service.image.tag | string | `"7.9.0-alpha.64"` |  |
...
| alfresco-identity-adapter-service.image.tag | string | `"7.9.0-alpha.32"` |  |
...
| alfresco-modeling-service.image.tag | string | `"7.9.0-alpha.53"` |  |
...
| alfresco-process-analytics-playground.image.tag | string | `"7.9.0-alpha.38"` |  |
...
| alfresco-process-analytics-service.image.tag | string | `"7.9.0-alpha.38"` |  |
