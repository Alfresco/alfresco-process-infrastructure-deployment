...
![Version: 7.10.0-rc.26](https://img.shields.io/badge/Version-7.10.0--rc.26-informational?style=flat-square) ![AppVersion: 7.10.0-rc.26](https://img.shields.io/badge/AppVersion-7.10.0--rc.26-informational?style=flat-square)
...
|------------|------|---------|
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-admin-app(common) | 7.10.0-alpha.2 |
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-process-analytics-playground(common) | 7.10.0-alpha.2 |
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-modeling-service(common) | 7.10.0-alpha.2 |
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-process-analytics-service(common) | 7.10.0-alpha.2 |
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-tika-service(common) | 7.10.0-alpha.2 |
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-modeling-app(common) | 7.10.0-alpha.2 |
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-deployment-service(common) | 7.10.0-alpha.2 |
| https://activiti.github.io/activiti-cloud-helm-charts | common | 7.10.0-alpha.2 |
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-identity-adapter-service(common) | 7.10.0-alpha.2 |
...
| alfresco-admin-app.image.tag | string | `"7.10.0-rc.26"` |  |
...
| alfresco-deployment-service.applications.image.tag | string | `"7.10.0-rc.26"` | default tag for all application images |
...
| alfresco-deployment-service.image.tag | string | `"7.10.0-rc.26"` |  |
...
| alfresco-identity-adapter-service.image.tag | string | `"7.10.0-rc.26"` |  |
...
| alfresco-modeling-app.image.tag | string | `"7.10.0-rc.26"` |  |
...
| alfresco-modeling-service.image.tag | string | `"7.10.0-rc.26"` |  |
...
| alfresco-process-analytics-playground.image.tag | string | `"7.10.0-rc.26"` |  |
...
| alfresco-process-analytics-service.image.tag | string | `"7.10.0-rc.26"` |  |
