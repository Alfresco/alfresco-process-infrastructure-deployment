...
| alfresco-admin-app.image.tag | string | `"7.1.0-M17.2"` |  |
...
| alfresco-modeling-app.image.tag | string | `"7.1.0-M17.2"` |  |
...
| alfresco-modeling-service.image.tag | string | `"7.1.0-M17.5"` |  |
