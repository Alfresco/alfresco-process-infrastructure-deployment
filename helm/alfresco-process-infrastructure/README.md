...
![Version: 7.10.0-alpha.60](https://img.shields.io/badge/Version-7.10.0--alpha.60-informational?style=flat-square) ![AppVersion: 7.10.0-SNAPSHOT](https://img.shields.io/badge/AppVersion-7.10.0--SNAPSHOT-informational?style=flat-square)
...
| alfresco-deployment-service.image.tag | string | `"7.10.0-alpha.67"` |  |
