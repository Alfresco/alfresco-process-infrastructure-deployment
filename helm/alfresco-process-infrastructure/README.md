...
![Version: 7.10.0-alpha.63](https://img.shields.io/badge/Version-7.10.0--alpha.63-informational?style=flat-square) ![AppVersion: 7.10.0-SNAPSHOT](https://img.shields.io/badge/AppVersion-7.10.0--SNAPSHOT-informational?style=flat-square)
...
| alfresco-deployment-service.image.tag | string | `"7.10.0-alpha.70"` |  |
...
| alfresco-identity-adapter-service.image.tag | string | `"7.10.0-alpha.34"` |  |
...
| alfresco-modeling-service.image.tag | string | `"7.10.0-alpha.48"` |  |
...
| alfresco-process-analytics-playground.image.tag | string | `"7.10.0-alpha.38"` |  |
...
| alfresco-process-analytics-service.image.tag | string | `"7.10.0-alpha.38"` |  |
