...
| alfresco-deployment-service.alfresco-content-services.activemq | object | `{"password":"admin","url":"tcp://acs-activemq-broker.acs:61616","username":"admin"}` | ACS ActiveMQ config for content connector events |
