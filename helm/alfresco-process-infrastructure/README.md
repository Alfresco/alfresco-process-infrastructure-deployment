...
| alfresco-deployment-service.applications.datadog.apiKey | string | `nil` |  |
| alfresco-deployment-service.applications.datadog.enabled | bool | `false` | enable support for Datadog tracing agent instrumentation for applications |
| alfresco-deployment-service.applications.datadog.javaLibVersion | string | `"v1.14.0"` |  |
| alfresco-deployment-service.applications.datadog.logInjectionEnabled | bool | `true` |  |
| alfresco-deployment-service.applications.datadog.metricsExportEnabled | bool | `false` |  |
| alfresco-deployment-service.applications.datadog.profilingEnabled | bool | `false` |  |
| alfresco-deployment-service.applications.datadog.traceAgentUrl | string | `nil` |  |
...
| global.datadog.enabled | bool | `false` | enable support for Datadog tracing agent instrumentation |
