...
![Version: 7.7.0-alpha.40](https://img.shields.io/badge/Version-7.7.0--alpha.40-informational?style=flat-square) ![AppVersion: 7.7.0](https://img.shields.io/badge/AppVersion-7.7.0-informational?style=flat-square)
...
| alfresco-deployment-service.image.tag | string | `"7.7.0-alpha.76"` |  |
...
| alfresco-identity-adapter-service.image.tag | string | `"7.7.0-alpha.44"` |  |
...
| alfresco-modeling-service.image.tag | string | `"7.7.0-alpha.48"` |  |
...
| alfresco-process-analytics-playground.image.tag | string | `"7.7.0-alpha.42"` |  |
...
| alfresco-process-analytics-service.image.tag | string | `"7.7.0-alpha.42"` |  |
