...
| alfresco-deployment-service.applications.image.tag | string | `"7.7.0"` | default tag for all application images |
...
| alfresco-deployment-service.image.tag | string | `"7.7.0"` |  |
...
| alfresco-identity-adapter-service.image.tag | string | `"7.7.0"` |  |
...
| alfresco-modeling-app.image.tag | string | `"7.7.0"` |  |
...
| alfresco-modeling-service.image.tag | string | `"7.7.0"` |  |
...
| alfresco-process-analytics-playground.image.tag | string | `"7.7.0"` |  |
...
| alfresco-process-analytics-service.image.tag | string | `"7.7.0"` |  |
