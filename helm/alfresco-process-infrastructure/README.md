...
![Version: 7.15.3-alpha.1](https://img.shields.io/badge/Version-7.15.3--alpha.1-informational?style=flat-square) ![AppVersion: 7.15.3-SNAPSHOT](https://img.shields.io/badge/AppVersion-7.15.3--SNAPSHOT-informational?style=flat-square)
...
| alfresco-deployment-service.image.tag | string | `"7.15.3-alpha.1"` |  |
