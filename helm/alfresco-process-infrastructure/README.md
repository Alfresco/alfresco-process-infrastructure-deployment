...
![Version: 7.18.0-alpha.4](https://img.shields.io/badge/Version-7.18.0--alpha.4-informational?style=flat-square) ![AppVersion: 7.18.0-SNAPSHOT](https://img.shields.io/badge/AppVersion-7.18.0--SNAPSHOT-informational?style=flat-square)
...
| alfresco-identity-adapter-service.image.tag | string | `"7.18.0-alpha.2"` |  |
