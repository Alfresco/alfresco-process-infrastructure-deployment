...
![Version: 7.16.0-alpha.77](https://img.shields.io/badge/Version-7.16.0--alpha.77-informational?style=flat-square) ![AppVersion: 7.16.0-SNAPSHOT](https://img.shields.io/badge/AppVersion-7.16.0--SNAPSHOT-informational?style=flat-square)
...
| alfresco-deployment-service.image.tag | string | `"7.16.0-alpha.80"` |  |
...
| alfresco-identity-adapter-service.image.tag | string | `"7.16.0-alpha.43"` |  |
...
| alfresco-modeling-service.image.tag | string | `"7.16.0-alpha.78"` |  |
...
| alfresco-process-analytics-playground.image.tag | string | `"7.16.0-alpha.53"` |  |
...
| alfresco-process-analytics-service.image.tag | string | `"7.16.0-alpha.53"` |  |
...
| alfresco-tika-service.image.tag | string | `"7.16.0-alpha.53"` |  |
