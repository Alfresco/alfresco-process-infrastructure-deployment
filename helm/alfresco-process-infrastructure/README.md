...
| alfresco-deployment-service.image.tag | string | `"7.19.1-alpha.1"` |  |
...
| alfresco-modeling-service.image.tag | string | `"7.19.1-alpha.1"` |  |
...
| alfresco-process-analytics-playground.image.tag | string | `"7.19.0"` |  |
...
| alfresco-process-analytics-service.image.tag | string | `"7.19.0"` |  |
...
| alfresco-tika-service.image.tag | string | `"7.19.0"` |  |
