...
| alfresco-deployment-service.image.tag | string | `"7.5.1-alpha.7"` |  |
...
| alfresco-identity-adapter-service.image.tag | string | `"7.5.1-alpha.2"` |  |
...
| alfresco-modeling-service.image.tag | string | `"7.5.1-alpha.2"` |  |
...
| alfresco-process-analytics-playground.image.tag | string | `"7.5.1-alpha.1"` |  |
...
| alfresco-process-analytics-service.image.tag | string | `"7.5.1-alpha.1"` |  |
