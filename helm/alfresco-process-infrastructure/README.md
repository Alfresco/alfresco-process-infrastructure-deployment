...
| alfresco-deployment-service.image.tag | string | `"7.5.0-alpha.19"` |  |
...
| alfresco-process-analytics-playground.image.tag | string | `"7.5.0-alpha.8"` |  |
...
| alfresco-process-analytics-service.image.tag | string | `"7.5.0-alpha.8"` |  |
