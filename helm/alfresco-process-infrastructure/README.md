...
![Version: 7.4.0](https://img.shields.io/badge/Version-7.4.0-informational?style=flat-square) ![AppVersion: 7.4.0](https://img.shields.io/badge/AppVersion-7.4.0-informational?style=flat-square)
...
| alfresco-deployment-service.applications.opensearch.host | string | `"{{ tpl .Values.global.opensearch.host $ }}"` |  |
| alfresco-deployment-service.applications.opensearch.password | string | `"{{ .Values.global.opensearch.password }}"` |  |
| alfresco-deployment-service.applications.opensearch.username | string | `"{{ .Values.global.opensearch.username }}"` |  |
...
| alfresco-process-analytics-playground.analyticsClientId | string | `"analytics-playground"` |  |
| alfresco-process-analytics-playground.analyticsClientIssuerUri | string | `"{{ include \"common.keycloak-url\" . }}/realms/{{ include \"common.keycloak-realm\" . }}"` |  |
| alfresco-process-analytics-playground.analyticsClientSecret | string | `"2181210d-ec04-4bcf-8649-8a5dcb1c6342"` |  |
...
| alfresco-process-analytics-playground.env.SPRING_SECURITY_OAUTH2_CLIENT_PROVIDER_KEYCLOAK_ISSUER_URI | string | `"{{ tpl .Values.analyticsClientIssuerUri $ }}"` |  |
| alfresco-process-analytics-playground.env.SPRING_SECURITY_OAUTH2_CLIENT_REGISTRATION_GRAPHQL_CLIENT_ID | string | `"{{ tpl .Values.analyticsClientId $ }}"` |  |
| alfresco-process-analytics-playground.env.SPRING_SECURITY_OAUTH2_CLIENT_REGISTRATION_GRAPHQL_CLIENT_SECRET | string | `"{{ tpl .Values.analyticsClientSecret $ }}"` |  |
...
| alfresco-process-analytics-service.env.ELASTICSEARCH_CLIENT_HOST | string | `"{{ tpl .Values.opensearch.host $ | quote }}"` |  |
| alfresco-process-analytics-service.env.ELASTICSEARCH_CLIENT_PASSWORD | string | `"{{ tpl .Values.opensearch.password $ | quote }}"` |  |
| alfresco-process-analytics-service.env.ELASTICSEARCH_CLIENT_USERNAME | string | `"{{ tpl .Values.opensearch.username $ | quote }}"` |  |
...
| alfresco-process-analytics-service.opensearch.host | string | `"{{ tpl .Values.global.opensearch.host $ }}"` |  |
| alfresco-process-analytics-service.opensearch.password | string | `"{{ .Values.global.opensearch.password }}"` |  |
| alfresco-process-analytics-service.opensearch.username | string | `"{{ .Values.global.opensearch.username }}"` |  |
...
| global | object | `{"acs":{"activemq":{"password":"","url":"","username":""},"admin":{"password":"","username":""},"enabled":false,"host":"{{ template \"common.gateway-host\" . }}","url":""},"gateway":{"annotations":{},"domain":"","host":"{{ template \"common.gateway-domain\" . }}","http":"false","tlsacme":"false"},"keycloak":{"clientId":"activiti-keycloak","clientSecret":"d2b835b5-efdf-4448-8d55-89eaaca9fc96","host":"{{ template \"common.gateway-host\" . }}","realm":"alfresco","resource":"alfresco","url":""},"opensearch":{"host":"http://opensearch-cluster-master.{{ .Release.Namespace }}.svc.cluster.local:9200","password":"admin","username":"admin"},"registryPullSecrets":["quay-registry-secret"]}` | for common values see https://github.com/Activiti/activiti-cloud-common-chart/blob/master/charts/common/README.md |
