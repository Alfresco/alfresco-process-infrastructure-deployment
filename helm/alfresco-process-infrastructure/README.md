...
| alfresco-identity-adapter-service.image.tag | string | `"7.8.0-alpha.22"` |  |
...
| alfresco-modeling-service.image.tag | string | `"7.8.0-alpha.26"` |  |
...
| alfresco-process-analytics-playground.image.tag | string | `"7.8.0-alpha.19"` |  |
...
| alfresco-process-analytics-service.image.tag | string | `"7.8.0-alpha.19"` |  |
