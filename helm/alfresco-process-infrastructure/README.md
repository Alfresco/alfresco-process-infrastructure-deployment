...
| alfresco-deployment-service.image.tag | string | `"7.11.0-alpha.56"` |  |
...
| alfresco-identity-adapter-service.image.tag | string | `"7.11.0-alpha.35"` |  |
...
| alfresco-modeling-service.image.tag | string | `"7.11.0-alpha.50"` |  |
...
| alfresco-process-analytics-playground.image.tag | string | `"7.11.0-alpha.42"` |  |
...
| alfresco-process-analytics-service.image.tag | string | `"7.11.0-alpha.42"` |  |
