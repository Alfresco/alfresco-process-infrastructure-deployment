...
| alfresco-deployment-service.image.tag | string | `"7.13.0-alpha.83"` |  |
...
| alfresco-modeling-service.image.tag | string | `"7.13.0-alpha.51"` |  |
...
| alfresco-process-analytics-playground.image.tag | string | `"7.13.0-alpha.39"` |  |
...
| alfresco-process-analytics-service.image.tag | string | `"7.13.0-alpha.39"` |  |
...
| alfresco-tika-service.image.tag | string | `"7.13.0-alpha.39"` |  |
