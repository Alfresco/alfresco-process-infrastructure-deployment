...
![Version: 7.10.0-alpha.51](https://img.shields.io/badge/Version-7.10.0--alpha.51-informational?style=flat-square) ![AppVersion: 7.10.0-SNAPSHOT](https://img.shields.io/badge/AppVersion-7.10.0--SNAPSHOT-informational?style=flat-square)
...
| alfresco-deployment-service.image.tag | string | `"7.10.0-alpha.57"` |  |
...
| alfresco-identity-adapter-service.image.tag | string | `"7.10.0-alpha.28"` |  |
...
| alfresco-modeling-service.image.tag | string | `"7.10.0-alpha.39"` |  |
...
| alfresco-process-analytics-playground.image.tag | string | `"7.10.0-alpha.31"` |  |
...
| alfresco-process-analytics-service.image.tag | string | `"7.10.0-alpha.31"` |  |
