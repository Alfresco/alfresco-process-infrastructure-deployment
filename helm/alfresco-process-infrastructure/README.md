...
| alfresco-deployment-service.applications.image.tag | string | `"7.19.0-rc.187"` | default tag for all application images |
...
| alfresco-deployment-service.image.tag | string | `"7.19.0-rc.187"` |  |
...
| alfresco-identity-adapter-service.image.tag | string | `"7.19.0-rc.187"` |  |
...
| alfresco-modeling-app.image.tag | string | `"7.19.0-rc.187"` |  |
...
| alfresco-modeling-service.image.tag | string | `"7.19.0-rc.187"` |  |
...
| alfresco-process-analytics-playground.image.tag | string | `"7.19.0-rc.187"` |  |
...
| alfresco-process-analytics-service.image.tag | string | `"7.19.0-rc.187"` |  |
...
| alfresco-static-resources.image.tag | string | `"7.19.0-rc.187"` |  |
...
| alfresco-tika-service.image.tag | string | `"7.19.0-rc.187"` |  |
