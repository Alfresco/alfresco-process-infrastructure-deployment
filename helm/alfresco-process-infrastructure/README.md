...
|------------|------|---------|
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-process-analytics-service(common) | 8.8.0-alpha.8 |
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-tika-service(common) | 8.8.0-alpha.8 |
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-modeling-service(common) | 8.8.0-alpha.8 |
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-static-resources(common) | 8.8.0-alpha.8 |
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-identity-adapter-service(common) | 8.8.0-alpha.8 |
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-modeling-app(common) | 8.8.0-alpha.8 |
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-admin-app(common) | 8.8.0-alpha.8 |
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-deployment-service(common) | 8.8.0-alpha.8 |
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-process-analytics-playground(common) | 8.8.0-alpha.8 |
| https://activiti.github.io/activiti-cloud-helm-charts | common | 8.8.0-alpha.8 |
...
| alfresco-deployment-service.image.tag | string | `"7.20.0-alpha.469"` |  |
...
| alfresco-identity-adapter-service.image.tag | string | `"7.20.0-alpha.203"` |  |
...
| alfresco-identity-service.realm.alfresco.extraClients[3].secret | string | `"2181210d-ec04-4bcf-4699-8a5dcb1c6342"` |  |
...
| alfresco-modeling-service.image.tag | string | `"7.20.0-alpha.469"` |  |
...
| alfresco-process-analytics-playground.graphql.client.oauth2ClientSecret | string | `"2181210d-ec04-4bcf-4699-8a5dcb1c6342"` |  |
...
| alfresco-process-analytics-playground.image.tag | string | `"7.20.0-alpha.260"` |  |
...
| alfresco-process-analytics-service.image.tag | string | `"7.20.0-alpha.260"` |  |
...
| alfresco-tika-service.image.tag | string | `"7.20.0-alpha.260"` |  |
