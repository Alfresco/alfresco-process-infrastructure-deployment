...
| alfresco-deployment-service.image.tag | string | `"7.18.0-alpha.97"` |  |
...
| alfresco-identity-adapter-service.image.tag | string | `"7.18.0-alpha.45"` |  |
...
| alfresco-modeling-service.image.tag | string | `"7.18.0-alpha.97"` |  |
