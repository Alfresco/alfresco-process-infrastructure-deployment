...
![Version: 7.16.0-alpha.15](https://img.shields.io/badge/Version-7.16.0--alpha.15-informational?style=flat-square) ![AppVersion: 7.16.0-SNAPSHOT](https://img.shields.io/badge/AppVersion-7.16.0--SNAPSHOT-informational?style=flat-square)
...
| alfresco-identity-adapter-service.image.tag | string | `"7.16.0-alpha.7"` |  |
...
| alfresco-process-analytics-playground.image.tag | string | `"7.16.0-alpha.7"` |  |
...
| alfresco-process-analytics-service.image.tag | string | `"7.16.0-alpha.7"` |  |
...
| alfresco-tika-service.image.tag | string | `"7.16.0-alpha.7"` |  |
