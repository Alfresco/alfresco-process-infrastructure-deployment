...
| alfresco-identity-adapter-service.image.tag | string | `"7.13.0-alpha.21"` |  |
...
| alfresco-modeling-service.image.tag | string | `"7.13.0-alpha.31"` |  |
...
| alfresco-process-analytics-playground.image.tag | string | `"7.13.0-alpha.22"` |  |
...
| alfresco-process-analytics-service.image.tag | string | `"7.13.0-alpha.22"` |  |
...
| alfresco-tika-service.image.tag | string | `"7.13.0-alpha.22"` |  |
