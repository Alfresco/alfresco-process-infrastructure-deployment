...
![Version: 7.13.0-rc.20](https://img.shields.io/badge/Version-7.13.0--rc.20-informational?style=flat-square) ![AppVersion: 7.13.0-rc.20](https://img.shields.io/badge/AppVersion-7.13.0--rc.20-informational?style=flat-square)
...
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-static-resources(common) | 7.12.0-alpha.3 |
...
| alfresco-admin-app.image.tag | string | `"7.13.0-rc.20"` |  |
...
| alfresco-deployment-service.applications.image.tag | string | `"7.13.0-rc.20"` | default tag for all application images |
...
| alfresco-deployment-service.image.tag | string | `"7.13.0-rc.20"` |  |
...
| alfresco-identity-adapter-service.image.tag | string | `"7.13.0-rc.20"` |  |
...
| alfresco-modeling-app.image.tag | string | `"7.13.0-rc.20"` |  |
...
| alfresco-modeling-service.image.tag | string | `"7.13.0-rc.20"` |  |
...
| alfresco-process-analytics-playground.image.tag | string | `"7.13.0-rc.20"` |  |
...
| alfresco-process-analytics-service.image.tag | string | `"7.13.0-rc.20"` |  |
...
| alfresco-tika-service.image.tag | string | `"7.13.0-alpha.34"` |  |
