...
![Version: 7.9.0-alpha.57](https://img.shields.io/badge/Version-7.9.0--alpha.57-informational?style=flat-square) ![AppVersion: 7.9.0-SNAPSHOT](https://img.shields.io/badge/AppVersion-7.9.0--SNAPSHOT-informational?style=flat-square)
...
| alfresco-deployment-service.image.tag | string | `"7.9.0-alpha.72"` |  |
...
| alfresco-identity-adapter-service.image.tag | string | `"7.9.0-alpha.37"` |  |
...
| alfresco-modeling-service.image.tag | string | `"7.9.0-alpha.59"` |  |
...
| alfresco-process-analytics-playground.image.tag | string | `"7.9.0-alpha.43"` |  |
...
| alfresco-process-analytics-service.image.tag | string | `"7.9.0-alpha.43"` |  |
