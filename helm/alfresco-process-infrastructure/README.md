...
![Version: 7.9.3-SNAPSHOT](https://img.shields.io/badge/Version-7.9.3--SNAPSHOT-informational?style=flat-square) ![AppVersion: 7.9.3-SNAPSHOT](https://img.shields.io/badge/AppVersion-7.9.3--SNAPSHOT-informational?style=flat-square)
...
| alfresco-deployment-service.applications.image.tag | string | `"7.9.x"` | default tag for all application images |
...
| alfresco-deployment-service.image.tag | string | `"7.9.3-SNAPSHOT"` |  |
...
| alfresco-identity-adapter-service.image.tag | string | `"7.9.3-SNAPSHOT"` |  |
...
| alfresco-modeling-app.image.tag | string | `"7.9.0"` |  |
...
| alfresco-modeling-service.image.tag | string | `"7.9.3-SNAPSHOT"` |  |
...
| alfresco-process-analytics-playground.image.tag | string | `"7.9.3-SNAPSHOT"` |  |
...
| alfresco-process-analytics-service.image.tag | string | `"7.9.3-SNAPSHOT"` |  |
