...
| alfresco-deployment-service.image.tag | string | `"7.19.4-alpha.1"` |  |
...
| alfresco-identity-adapter-service.image.tag | string | `"7.19.4-alpha.2"` |  |
...
| alfresco-modeling-service.image.tag | string | `"7.19.4-alpha.1"` |  |
...
| alfresco-process-analytics-playground.image.tag | string | `"7.19.4-alpha.1"` |  |
...
| alfresco-process-analytics-service.image.tag | string | `"7.19.4-alpha.1"` |  |
...
| alfresco-tika-service.image.tag | string | `"7.19.4-alpha.1"` |  |
