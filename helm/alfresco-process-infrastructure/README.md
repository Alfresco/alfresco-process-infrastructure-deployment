...
![Version: 7.12.0-rc.100](https://img.shields.io/badge/Version-7.12.0--rc.100-informational?style=flat-square) ![AppVersion: 7.12.0-rc.100](https://img.shields.io/badge/AppVersion-7.12.0--rc.100-informational?style=flat-square)
...
|------------|------|---------|
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-admin-app(common) | 7.12.0-alpha.1 |
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-process-analytics-playground(common) | 7.12.0-alpha.1 |
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-modeling-service(common) | 7.12.0-alpha.1 |
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-process-analytics-service(common) | 7.12.0-alpha.1 |
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-tika-service(common) | 7.12.0-alpha.1 |
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-modeling-app(common) | 7.12.0-alpha.1 |
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-deployment-service(common) | 7.12.0-alpha.1 |
| https://activiti.github.io/activiti-cloud-helm-charts | common | 7.12.0-alpha.1 |
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-identity-adapter-service(common) | 7.12.0-alpha.1 |
...
| alfresco-admin-app.image.tag | string | `"7.12.0-rc.100"` |  |
...
| alfresco-deployment-service.applications.datadog.javaLibVersion | string | `nil` |  |
| alfresco-deployment-service.applications.datadog.logsInjectionEnabled | bool | `true` | configures application Datadog trace agent logs injection support. |
| alfresco-deployment-service.applications.datadog.metrics.apiKey | string | `nil` | configures application Datadog metrics export api key. Required if metrics.enabled is true |
| alfresco-deployment-service.applications.datadog.metrics.applicationKey | string | `nil` | configures application Datadog metrics export application key if needed. |
| alfresco-deployment-service.applications.datadog.metrics.batchSize | string | `nil` | configures application Datadog metrics export batch size, i.e. 10000. |
| alfresco-deployment-service.applications.datadog.metrics.connectTimeout | string | `nil` | configures application Datadog metrics export connect timeout, i.e. PT1S. |
| alfresco-deployment-service.applications.datadog.metrics.descriptions | bool | `true` | enables application Datadog metrics export details. |
| alfresco-deployment-service.applications.datadog.metrics.enabled | bool | `false` | enables application Datadog metrics registry export. |
| alfresco-deployment-service.applications.datadog.metrics.hostTag | string | `nil` | configures application Datadog metrics export host tag property, i.e. instance |
| alfresco-deployment-service.applications.datadog.metrics.readTimeout | string | `nil` | configures application Datadog metrics export read timeout, i.e. PT10S. |
| alfresco-deployment-service.applications.datadog.metrics.step | string | `nil` | configures application Datadog metrics registry step interval, i.e. PT1M |
| alfresco-deployment-service.applications.datadog.metrics.uri | string | `nil` | configures application Datadog metrics export uri, i.e. https://api.datadoghq.com |
| alfresco-deployment-service.applications.datadog.profilingEnabled | bool | `false` | configures application Datadog trace agent profiling support. |
...
| alfresco-deployment-service.applications.image.tag | string | `"7.12.0-rc.100"` | default tag for all application images |
...
| alfresco-deployment-service.image.tag | string | `"7.12.0-rc.100"` |  |
...
| alfresco-identity-adapter-service.image.tag | string | `"7.12.0-rc.100"` |  |
...
| alfresco-modeling-app.image.tag | string | `"7.12.0-rc.100"` |  |
...
| alfresco-modeling-service.image.tag | string | `"7.12.0-rc.100"` |  |
...
| alfresco-process-analytics-playground.image.tag | string | `"7.12.0-rc.100"` |  |
...
| alfresco-process-analytics-service.image.tag | string | `"7.12.0-rc.100"` |  |
...
| global.datadog.admissionEnabled | bool | `true` | enables application Datadog trace agent admission webhook instrumentation |
| global.datadog.enabled | bool | `false` | enable support for Datadog tracing agent instrumentation for AAE and runtime application services |
| global.datadog.env | string | `nil` | configures Datadog trace agent environment tag. Required if enabled is true. |
| global.datadog.logsInjectionEnabled | bool | `true` | configures Datadog trace agent logs injection support. |
| global.datadog.profilingEnabled | bool | `false` | configures Datadog trace agent profiling support. |
| global.datadog.traceAgentUrl | string | `nil` | configured default Datadog trace agent url, if needed, i.e. unix:///var/run/datadog/apm.socket |
