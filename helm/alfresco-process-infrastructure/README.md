...
| alfresco-process-analytics-playground.image.tag | string | `"7.17.0-alpha.1"` |  |
...
| alfresco-process-analytics-service.image.tag | string | `"7.17.0-alpha.1"` |  |
...
| alfresco-tika-service.image.tag | string | `"7.17.0-alpha.1"` |  |
